...
goog.tagUnsealableClass = function (ctr) {
    if (!COMPILED && goog.defineClass.SEAL_CLASS_INSTANCES) {
        ctr.prototype[goog.UNSEALABLE_CONSTRUCTOR_PROPERTY_] = !0
    }
};
...
box2d.b2AddVV = function (a, b, out) {
    out.x = a.x + b.x;
    out.y = a.y + b.y;
    return out
}
box2d.b2SubVV = function (a, b, out) {
    out.x = a.x - b.x;
    out.y = a.y - b.y;
    return out
}
box2d.b2MulSV = function (s, v, out) {
    out.x = v.x * s;
    out.y = v.y * s;
    return out
}
box2d.b2AddVMulSV = function (a, s, b, out) {
    out.x = a.x + (s * b.x);
    out.y = a.y + (s * b.y);
    return out
}
box2d.b2SubVMulSV = function (a, s, b, out) {
    out.x = a.x - (s * b.x);
    out.y = a.y - (s * b.y);
    return out
}
...
box2d.b2MidVV = function (a, b, out) {
    out.x = (a.x + b.x) * 0.5;
    out.y = (a.y + b.y) * 0.5;
    return out
}
box2d.b2ExtVV = function (a, b, out) {
    out.x = (b.x - a.x) * 0.5;
    out.y = (b.y - a.y) * 0.5;
    return out
}
...
box2d.b2Mat22.prototype.SetAngleDegrees = function (angle) {
    return this.SetAngle(box2d.b2DegToRad(angle))
}
...
box2d.b2Rot.prototype.SetAngleDegrees = function (angle) {
    return this.SetAngle(box2d.b2DegToRad(angle))
}
...
box2d.b2MulRR = function (q, r, out) {
    ...
    while (out.angle < -box2d.b2_pi) {
        out.angle += box2d.b2_two_pi
    }
    while (out.angle >= box2d.b2_pi) {
        out.angle -= box2d.b2_two_pi
    }
...
box2d.b2Sweep.prototype.a0 = 0.0;
...
box2d.b2RevoluteJoint.prototype.InitVelocityConstraints = function (data) {
    ...
    if (this.m_enableMotor === !1 || fixedRotation) {
        this.m_motorImpulse = 0
    }
    if (this.m_enableLimit && fixedRotation === !1) {
...
box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints = function (data) {
    ...
    var iA = this.m_invIA,
        iB = this.m_invIB;
    var fixedRotation = (iA + iB === 0);
    if (this.m_enableMotor && this.m_limitState !== box2d.b2LimitState.e_equalLimits && fixedRotation === !1) {
    ...
    if (this.m_enableLimit && this.m_limitState !== box2d.b2LimitState.e_inactiveLimit && fixedRotation === !1) {
        var Cdot1 = box2d.b2SubVV(box2d.b2AddVCrossSV(vB, wB, this.m_rB, box2d.b2Vec2.s_t0), box2d.b2AddVCrossSV(vA, wA, this.m_rA, box2d.b2Vec2.s_t1), box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints.s_Cdot1)
        var Cdot2 = wB - wA;
        ...
        var Cdot = box2d.b2SubVV(box2d.b2AddVCrossSV(vB, wB, this.m_rB, box2d.b2Vec2.s_t0), box2d.b2AddVCrossSV(vA, wA, this.m_rA, box2d.b2Vec2.s_t1), box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints.s_Cdot)
...
box2d.b2RevoluteJoint.prototype.SolvePositionConstraints = function (data) {
    ...
    if (this.m_enableLimit && this.m_limitState !== box2d.b2LimitState.e_inactiveLimit && fixedRotation === !1) {
        ...
        var C = box2d.b2SubVV(box2d.b2AddVV(cB, rB, box2d.b2Vec2.s_t0), box2d.b2AddVV(cA, rA, box2d.b2Vec2.s_t1), box2d.b2RevoluteJoint.prototype.SolvePositionConstraints.s_C);
...
box2d.b2PrismaticJoint.prototype.InitVelocityConstraints = function (data) {
    ...
    box2d.b2SubVV(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB);
    var rB = box2d.b2MulRV(qB, this.m_lalcB, this.m_rB);
    var d = box2d.b2AddVV(box2d.b2SubVV(cB, cA, box2d.b2Vec2.s_t0), box2d.b2SubVV(rB, rA, box2d.b2Vec2.s_t1), box2d.b2PrismaticJoint.prototype.InitVelocityConstraints.s_d);
    var mA = this.m_invMassA,
        mB = this.m_invMassB;
    var iA = this.m_invIA,
        iB = this.m_invIB; {
    ...
    if (data.step.warmStarting) {
        this.m_impulse.SelfMul(data.step.dtRatio);
        this.m_motorImpulse *= data.step.dtRatio;
        var P = box2d.b2AddVV(box2d.b2MulSV(this.m_impulse.x, this.m_perp, box2d.b2Vec2.s_t0), box2d.b2MulSV((this.m_motorImpulse + this.m_impulse.z), this.m_axis, box2d.b2Vec2.s_t1), box2d.b2PrismaticJoint.prototype.InitVelocityConstraints.s_P);
...
box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints = function (data) {
    ...
    if (this.m_enableLimit && this.m_limitState !== box2d.b2LimitState.e_inactiveLimit) {
        ...
        var P = box2d.b2AddVV(box2d.b2MulSV(df.x, this.m_perp, box2d.b2Vec2.s_t0), box2d.b2MulSV(df.z, this.m_axis, box2d.b2Vec2.s_t1), box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints.s_P);
...
box2d.b2PrismaticJoint.prototype.SolvePositionConstraints = function (data) {
    ...
    var rA = box2d.b2MulRV(qA, this.m_lalcA, this.m_rA);
    var rB = box2d.b2MulRV(qB, this.m_lalcB, this.m_rB);
    var d = box2d.b2SubVV(box2d.b2AddVV(cB, rB, box2d.b2Vec2.s_t0), box2d.b2AddVV(cA, rA, box2d.b2Vec2.s_t1), box2d.b2PrismaticJoint.prototype.SolvePositionConstraints.s_d);
    ...
    var P = box2d.b2AddVV(box2d.b2MulSV(impulse.x, perp, box2d.b2Vec2.s_t0), box2d.b2MulSV(impulse.z, axis, box2d.b2Vec2.s_t1), box2d.b2PrismaticJoint.prototype.SolvePositionConstraints.s_P);
...
box2d.b2PrismaticJoint.prototype.GetJointSpeed = function () {
    ...
    var pA = box2d.b2AddVV(bA.m_sweep.c, rA, box2d.b2Vec2.s_t0);
    var pB = box2d.b2AddVV(bB.m_sweep.c, rB, box2d.b2Vec2.s_t1);
    var d = box2d.b2SubVV(pB, pA, box2d.b2Vec2.s_t2);
...
box2d.b2GearJoint = function (def) {
    ...
    if (this.m_typeA === box2d.b2JointType.e_revoluteJoint) {
        ...
        var pA = box2d.b2MulTRV(xfC.q, box2d.b2AddVV(box2d.b2MulRV(xfA.q, this.m_localAnchorA, box2d.b2Vec2.s_t0), box2d.b2SubVV(xfA.p, xfC.p, box2d.b2Vec2.s_t1), box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0);
    ...
    if (this.m_typeB === box2d.b2JointType.e_revoluteJoint) {
        ...
        var pB = box2d.b2MulTRV(xfD.q, box2d.b2AddVV(box2d.b2MulRV(xfB.q, this.m_localAnchorB, box2d.b2Vec2.s_t0), box2d.b2SubVV(xfB.p, xfD.p, box2d.b2Vec2.s_t1), box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0);
...
box2d.b2GearJoint.prototype.SolvePositionConstraints = function (data) {
    ...
    if (this.m_typeA === box2d.b2JointType.e_revoluteJoint) {
        ...
        var pC = this.m_lalcC;
        var pA = box2d.b2MulTRV(qC, box2d.b2AddVV(rA, box2d.b2SubVV(cA, cC, box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0);
        coordinateA = box2d.b2DotVV(box2d.b2SubVV(pA, pC, box2d.b2Vec2.s_t0), this.m_localAxisC)
    }
    if (this.m_typeB === box2d.b2JointType.e_revoluteJoint) {
        JvBD.SetZero();
        ...
        var pD = this.m_lalcD;
        var pB = box2d.b2MulTRV(qD, box2d.b2AddVV(rB, box2d.b2SubVV(cB, cD, box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0);
        coordinateB = box2d.b2DotVV(box2d.b2SubVV(pB, pD, box2d.b2Vec2.s_t0), this.m_localAxisD)
    }
...
box2d.b2Simplex.prototype.Solve2 = function () {
    var w1 = this.m_v1.w;
    var w2 = this.m_v2.w;
    var e12 = box2d.b2SubVV(w2, w1, box2d.b2Simplex.s_e12);
...
box2d.b2Simplex.prototype.Solve3 = function () {
    ...
    var d12_1 = w2e12;
    var d12_2 = (-w1e12);
    var e13 = box2d.b2SubVV(w3, w1, box2d.b2Simplex.s_e13);
    var w1e13 = box2d.b2DotVV(w1, e13);
    var w3e13 = box2d.b2DotVV(w3, e13);
    var d13_1 = w3e13;
    var d13_2 = (-w1e13);
    var e23 = box2d.b2SubVV(w3, w2, box2d.b2Simplex.s_e23);
...
box2d.b2Distance = function (output, cache, input) {
    ...
    if (input.useRadii) {
        ...
        if (output.distance > (rA + rB) && output.distance > box2d.b2_epsilon) {
            ...
            var normal = box2d.b2SubVV(output.pointB, output.pointA, box2d.b2Distance.s_normal);
            normal.Normalize();
            output.pointA.SelfMulAdd(rA, normal);
            output.pointB.SelfMulSub(rB, normal)
        } else {
            var p = box2d.b2MidVV(output.pointA, output.pointB, box2d.b2Distance.s_p);
...
box2d.b2WeldJoint.prototype.SolveVelocityConstraints = function (data) {
    ...
    if (this.m_frequencyHz > 0) {
        ...
        wA -= iA * impulse2;
        wB += iB * impulse2;
        var Cdot1 = box2d.b2SubVV(box2d.b2AddVCrossSV(vB, wB, this.m_rB, box2d.b2Vec2.s_t0), box2d.b2AddVCrossSV(vA, wA, this.m_rA, box2d.b2Vec2.s_t1), box2d.b2WeldJoint.prototype.SolveVelocityConstraints.s_Cdot1)
...
box2d.b2WeldJoint.prototype.SolvePositionConstraints = function (data) {
    ...
    K.ez.z = iA + iB;
    if (this.m_frequencyHz > 0) {
        var C1 = box2d.b2SubVV(box2d.b2AddVV(cB, rB, box2d.b2Vec2.s_t0), box2d.b2AddVV(cA, rA, box2d.b2Vec2.s_t1), box2d.b2WeldJoint.prototype.SolvePositionConstraints.s_C1);
        ...
        var impulse = K.Solve33(C1.x, C1.y, C2, box2d.b2WeldJoint.prototype.SolvePositionConstraints.s_impulse).SelfNeg();
        ...
        case box2d.b2ManifoldType.e_circles:
            {
                ...
                var cB = box2d.b2SubVMulSV(pointB, radiusB, this.normal, box2d.b2WorldManifold.prototype.Initialize.s_cB);box2d.b2MidVV(cA, cB, this.points[0]);this.separations[0] = box2d.b2DotVV(box2d.b2SubVV(cB, cA, box2d.b2Vec2.s_t0), this.normal)
            }
            break;
        case box2d.b2ManifoldType.e_faceA:
            {
                ...
                for (var i = 0, ict = manifold.pointCount; i < ict; ++i) {
                    ...
                    this.separations[i] = box2d.b2DotVV(box2d.b2SubVV(cB, cA, box2d.b2Vec2.s_t0), this.normal)
                }
            }
            break;
        case box2d.b2ManifoldType.e_faceB:
            {
                ...
                for (var i = 0, ict = manifold.pointCount; i < ict; ++i) {
                    ...
                    box2d.b2MidVV(cA, cB, this.points[i]);
                    this.separations[i] = box2d.b2DotVV(box2d.b2SubVV(cA, cB, box2d.b2Vec2.s_t0), this.normal)
                }
                this.normal.SelfNeg()
            }
            break
...
box2d.b2SeparationFunction.prototype.Initialize = function (cache, proxyA, sweepA, proxyB, sweepB, t1) {
    ...
    if (count === 1) {
        ...
        var pointA = box2d.b2MulXV(xfA, localPointA, box2d.b2TimeOfImpact.s_pointA);
        var pointB = box2d.b2MulXV(xfB, localPointB, box2d.b2TimeOfImpact.s_pointB);
        ...
        var normal = box2d.b2MulRV(xfB.q, this.m_axis, box2d.b2TimeOfImpact.s_normal);
        box2d.b2MidVV(localPointB1, localPointB2, this.m_localPoint);
        var pointB = box2d.b2MulXV(xfB, this.m_localPoint, box2d.b2TimeOfImpact.s_pointB);
        var localPointA = this.m_proxyA.GetVertex(cache.indexA[0]);
        var pointA = box2d.b2MulXV(xfA, localPointA, box2d.b2TimeOfImpact.s_pointA);
        ...
        var normal = box2d.b2MulRV(xfA.q, this.m_axis, box2d.b2TimeOfImpact.s_normal);
        box2d.b2MidVV(localPointA1, localPointA2, this.m_localPoint);
        var pointA = box2d.b2MulXV(xfA, this.m_localPoint, box2d.b2TimeOfImpact.s_pointA);
        var localPointB = this.m_proxyB.GetVertex(cache.indexB[0]);
        var pointB = box2d.b2MulXV(xfB, localPointB, box2d.b2TimeOfImpact.s_pointB);
...
box2d.b2SeparationFunction.prototype.FindMinSeparation = function (indexA, indexB, t) {
    ...
    switch (this.m_type) {
        case box2d.b2SeparationFunctionType.e_points:
            {
                var axisA = box2d.b2MulTRV(xfA.q, this.m_axis, box2d.b2TimeOfImpact.s_axisA);
                var axisB = box2d.b2MulTRV(xfB.q, box2d.b2NegV(this.m_axis, box2d.b2Vec2.s_t0), box2d.b2TimeOfImpact.s_axisB);indexA[0] = this.m_proxyA.GetSupport(axisA);indexB[0] = this.m_proxyB.GetSupport(axisB);
        ...
        case box2d.b2SeparationFunctionType.e_faceA:
            {
                var normal = box2d.b2MulRV(xfA.q, this.m_axis, box2d.b2TimeOfImpact.s_normal);
                var pointA = box2d.b2MulXV(xfA, this.m_localPoint, box2d.b2TimeOfImpact.s_pointA);
                var axisB = box2d.b2MulTRV(xfB.q, box2d.b2NegV(normal, box2d.b2Vec2.s_t0), box2d.b2TimeOfImpact.s_axisB);indexA[0] = -1;indexB[0] = this.m_proxyB.GetSupport(axisB);
                var localPointB = this.m_proxyB.GetVertex(indexB[0]);
                var pointB = box2d.b2MulXV(xfB, localPointB, box2d.b2TimeOfImpact.s_pointB);
        ...
        case box2d.b2SeparationFunctionType.e_faceB:
            {
                var normal = box2d.b2MulRV(xfB.q, this.m_axis, box2d.b2TimeOfImpact.s_normal);
                var pointB = box2d.b2MulXV(xfB, this.m_localPoint, box2d.b2TimeOfImpact.s_pointB);
                var axisA = box2d.b2MulTRV(xfA.q, box2d.b2NegV(normal, box2d.b2Vec2.s_t0), box2d.b2TimeOfImpact.s_axisA);indexB[0] = -1;indexA[0] = this.m_proxyA.GetSupport(axisA);
                var localPointA = this.m_proxyA.GetVertex(indexA[0]);
                var pointA = box2d.b2MulXV(xfA, localPointA, box2d.b2TimeOfImpact.s_pointA);
...
box2d.b2Contact.prototype.Update = function (listener) {
    ...
    if (wasTouching === !1 && touching === !0 && listener) {
        listener.BeginContact(this)
    }
    if (wasTouching === !0 && touching === !1 && listener) {
        listener.EndContact(this)
    }
    if (sensor === !1 && touching && listener) {
...
box2d.b2PolygonShape.prototype.Set = function (vertices, count) {
    ...
    for (var i = 0, ict = m; i < ict; ++i) {
        ...
        var edge = box2d.b2SubVV(vertexi2, vertexi1, box2d.b2Vec2.s_t0);
        if (box2d.ENABLE_ASSERTS) {
...
box2d.b2PolygonShape.prototype.ComputeSubmergedArea = function (normal, offset, xf, c) {
    ...
    var intoVec = box2d.b2PolygonShape.prototype.ComputeSubmergedArea.s_intoVec.SetXY(this.m_vertices[intoIndex].x * (1 - intoLamdda) + this.m_vertices[intoIndex2].x * intoLamdda, this.m_vertices[intoIndex].y * (1 - intoLamdda) + this.m_vertices[intoIndex2].y * intoLamdda);
    var outoVec = box2d.b2PolygonShape.prototype.ComputeSubmergedArea.s_outoVec.SetXY(this.m_vertices[outoIndex].x * (1 - outoLamdda) + this.m_vertices[outoIndex2].x * outoLamdda, this.m_vertices[outoIndex].y * (1 - outoLamdda) + this.m_vertices[outoIndex2].y * outoLamdda);
    var area = 0;
...
box2d.b2CollideEdgeAndCircle = function (manifold, edgeA, xfA, circleB, xfB) {
    ...
    var Q = box2d.b2MulTXV(xfA, box2d.b2MulXV(xfB, circleB.m_p, box2d.b2Vec2.s_t0), box2d.b2CollideEdgeAndCircle.s_Q);
    var A = edgeA.m_vertex1;
    var B = edgeA.m_vertex2;
    var e = box2d.b2SubVV(B, A, box2d.b2CollideEdgeAndCircle.s_e);
    ...
    if (v <= 0) {
        var P = A;
        var d = box2d.b2SubVV(Q, P, box2d.b2CollideEdgeAndCircle.s_d);
        ...
        if (edgeA.m_hasVertex0) {
            ...
            var B1 = A;
            var e1 = box2d.b2SubVV(B1, A1, box2d.b2CollideEdgeAndCircle.s_e1);
    ...
    if (u <= 0) {
        ...
        if (edgeA.m_hasVertex3) {
            ...
            var A2 = B;
            var e2 = box2d.b2SubVV(B2, A2, box2d.b2CollideEdgeAndCircle.s_e2);
    ...
    var n = box2d.b2CollideEdgeAndCircle.s_n.SetXY(-e.y, e.x);
...
box2d.b2EPCollider.prototype.Collide = function (manifold, edgeA, xfA, polygonB, xfB) {
    ...
    var edge1 = box2d.b2SubVV(this.m_v2, this.m_v1, box2d.b2EPCollider.s_edge1);
    edge1.Normalize();
    ...
    var convex2 = !1;
    if (hasVertex0) {
        var edge0 = box2d.b2SubVV(this.m_v1, this.m_v0, box2d.b2EPCollider.s_edge0);
        edge0.Normalize();
    ...
    if (hasVertex3) {
        var edge2 = box2d.b2SubVV(this.m_v3, this.m_v2, box2d.b2EPCollider.s_edge2);
        edge2.Normalize();
...
box2d.b2EPCollider.prototype.ComputePolygonSeparation = function (out) {
    ...
    axis.index = -1;
    axis.separation = -box2d.b2_maxFloat;
    var perp = box2d.b2EPCollider.s_perp.SetXY(-this.m_normal.y, this.m_normal.x);
    for (var i = 0, ict = this.m_polygonB.count; i < ict; ++i) {
        var n = box2d.b2NegV(this.m_polygonB.normals[i], box2d.b2EPCollider.s_n);
...
box2d.b2ChainShape.prototype.RayCast = function (output, input, xf, childIndex) {
    ...
    var edgeShape = box2d.b2ChainShape.s_edgeShape;
...
box2d.b2ChainShape.prototype.ComputeAABB = function (aabb, xf, childIndex) {
    ...
    var v1 = box2d.b2MulXV(xf, vertexi1, box2d.b2ChainShape.prototype.ComputeAABB.s_v1);
    var v2 = box2d.b2MulXV(xf, vertexi2, box2d.b2ChainShape.prototype.ComputeAABB.s_v2);
    box2d.b2MinV(v1, v2, aabb.lowerBound);
    box2d.b2MaxV(v1, v2, aabb.upperBound)
}
...
box2d.b2FindMaxSeparation = function (edgeIndex, poly1, xf1, poly2, xf2) {
    ...
    var xf = box2d.b2MulTXX(xf2, xf1, box2d.b2FindMaxSeparation.s_xf);
    var bestIndex = 0;
    var maxSeparation = -box2d.b2_maxFloat;
    for (var i = 0; i < count1; ++i) {
        var n = box2d.b2MulRV(xf.q, n1s[i], box2d.b2FindMaxSeparation.s_n);
        var v1 = box2d.b2MulXV(xf, v1s[i], box2d.b2FindMaxSeparation.s_v1);
        var si = box2d.b2_maxFloat;
        for (var j = 0; j < count2; ++j) {
            var sij = box2d.b2DotVV(n, box2d.b2SubVV(v2s[j], v1, box2d.b2Vec2.s_t0));
            if (sij < si) {
                si = sij
            }
        }
...
box2d.b2ContactSolver.prototype.InitializeVelocityConstraints = function () {
    ...
    for (i = 0, ict = this.m_count; i < ict; ++i) {
        ...
        box2d.b2CrossVOne(vc.normal, vc.tangent);
...
box2d.b2PositionSolverManifold.prototype.Initialize = function (pc, xfA, xfB, index) {
    ...
    switch (pc.type) {
        case box2d.b2ManifoldType.e_circles:
            {
                box2d.b2MulXV(xfA, pc.localPoint, pointA);box2d.b2MulXV(xfB, pc.localPoints[0], pointB);box2d.b2SubVV(pointB, pointA, this.normal).SelfNormalize();box2d.b2MidVV(pointA, pointB, this.point);this.separation = box2d.b2DotVV(box2d.b2SubVV(pointB, pointA, box2d.b2Vec2.s_t0), this.normal) - pc.radiusA - pc.radiusB
            }
            break;
        case box2d.b2ManifoldType.e_faceA:
            {
                box2d.b2MulRV(xfA.q, pc.localNormal, this.normal);box2d.b2MulXV(xfA, pc.localPoint, planePoint);box2d.b2MulXV(xfB, pc.localPoints[index], clipPoint);this.separation = box2d.b2DotVV(box2d.b2SubVV(clipPoint, planePoint, box2d.b2Vec2.s_t0), this.normal) - pc.radiusA - pc.radiusB;this.point.Copy(clipPoint)
            }
            break;
        case box2d.b2ManifoldType.e_faceB:
            {
                box2d.b2MulRV(xfB.q, pc.localNormal, this.normal);box2d.b2MulXV(xfB, pc.localPoint, planePoint);box2d.b2MulXV(xfA, pc.localPoints[index], clipPoint);this.separation = box2d.b2DotVV(box2d.b2SubVV(clipPoint, planePoint, box2d.b2Vec2.s_t0), this.normal) - pc.radiusA - pc.radiusB;this.point.Copy(clipPoint);this.normal.SelfNeg()
            }
            break
    }
}
...
box2d.b2Island.prototype.Solve = function (profile, step, gravity, allowSleep) {
    ...
    for (var i = 0; i < this.m_bodyCount; ++i) {
        ...
        var translation = box2d.b2MulSV(h, v, box2d.b2Island.s_translation);
    ...
    if (allowSleep) {
        ...
        for (var i = 0; i < this.m_bodyCount; ++i) {
            ...
            if ((b.m_flags & box2d.b2BodyFlag.e_autoSleepFlag) === 0 || b.m_angularVelocity * b.m_angularVelocity > angTolSqr || box2d.b2DotVV(b.m_linearVelocity, b.m_linearVelocity) > linTolSqr) {
                b.m_sleepTime = 0;
                minSleepTime = 0
            } else {
                b.m_sleepTime += h;
...
box2d.b2ContactFactory.prototype.AddType = function (createFcn, destroyFcn, type1, type2) {
    if (!0) {
        ...
        this.m_registers[type1][type2].primary = !0;
        if (type1 !== type2) {
            ...
            this.m_registers[type2][type1].primary = !1
        }
    }
}
...
box2d.b2ContactFactory.prototype.Destroy = function (contact) {
    ...
    if (contact.m_manifold.pointCount > 0 && fixtureA.IsSensor() === !1 && fixtureB.IsSensor() === !1) {
        fixtureA.GetBody().SetAwake(!0);
        fixtureB.GetBody().SetAwake(!0)
    }
...
box2d.b2DynamicTree.prototype.RayCast = function (callback, input) {
    ...
    var p1 = input.p1;
    var p2 = input.p2;
    var r = box2d.b2SubVV(p2, p1, box2d.b2DynamicTree.s_r);
    if (box2d.ENABLE_ASSERTS) {
        box2d.b2Assert(r.GetLengthSquared() > 0)
    }
    r.Normalize();
    var v = box2d.b2CrossOneV(r, box2d.b2DynamicTree.s_v);
    var abs_v = box2d.b2AbsV(v, box2d.b2DynamicTree.s_abs_v);
    ...
    while (stack.GetCount() > 0) {
        ...
        if (box2d.b2TestOverlapAABB(node.aabb, segmentAABB) === !1) {
            continue
        }
...
box2d.b2ContactManager.prototype.Collide = function () {
    ...
    while (c) {
        ...
        if (c.m_flags & box2d.b2ContactFlag.e_filterFlag) {
            ...
            if (this.m_contactFilter && this.m_contactFilter.ShouldCollide(fixtureA, fixtureB) === !1) {
                cNuke = c;
                c = cNuke.m_next;
                this.Destroy(cNuke);
                continue
...
box2d.b2ContactManager.prototype.AddPair = function (proxyUserDataA, proxyUserDataB) {
    ...
    if (fixtureA.IsSensor() === !1 && fixtureB.IsSensor() === !1) {
        bodyA.SetAwake(!0);
        bodyB.SetAwake(!0)
    }
    ++this.m_contactCount
...
box2d.b2Body.prototype.CreateFixture = function (def) {
    if (box2d.ENABLE_ASSERTS) {
        box2d.b2Assert(this.m_world.IsLocked() === !1)
    }
...
box2d.b2Body.prototype.SetTransformXYRadians = function (x, y, angle) {
    ...
    if ((this.m_xf.p.x === x) && (this.m_xf.p.y === y) && (this.m_xf.q.GetAngleRadians()) === angle) {
        return
    }
...
box2d.b2Body.prototype.SetAngleDegrees = function (angle) {
    this.SetAngle(box2d.b2DegToRad(angle))
}
...
box2d.b2Body.prototype.ShouldCollide = function (other) {
    ...
    for (var jn = this.m_jointList; jn; jn = jn.next) {
        if (jn.other === other) {
            if (jn.joint.m_collideConnected === !1) {
                return !1
            }
        }
    }
...
box2d.b2World.prototype.CreateBody = function (def) {
    if (box2d.ENABLE_ASSERTS) {
        box2d.b2Assert(this.IsLocked() === !1)
    }
    if (this.IsLocked()) {
        return null
    }
...
box2d.b2World.prototype.Solve = function (step) {
    ...
    for (var seed = this.m_bodyList; seed; seed = seed.m_next) {
        ...
        if (seed.IsAwake() === !1 || seed.IsActive() === !1) {
            continue
        }
        ...
        while (stackCount > 0) {
            ...
            for (var ce = b.m_contactList; ce; ce = ce.next) {
                ...
                if (contact.IsEnabled() === !1 || contact.IsTouching() === !1) {
                    continue
                }
...
box2d.b2World.prototype.SolveTOI = function (step) {
    ...
    for (;;) {
        ...
        if (minContact.IsEnabled() === !1 || minContact.IsTouching() === !1) {
            minContact.SetEnabled(!1);
        ...
        for (var i = 0; i < 2; ++i) {
            ...
            if (body.m_type === box2d.b2BodyType.b2_dynamicBody) {
                for (var ce = body.m_contactList; ce; ce = ce.next) {
                    ...
                    var other = ce.other;
                    if (other.m_type === box2d.b2BodyType.b2_dynamicBody && body.IsBullet() === !1 && other.IsBullet() === !1) {
                        continue
                    }
                    var sensorA = contact.m_fixtureA.m_isSensor;
                    var sensorB = contact.m_fixtureB.m_isSensor;
                    ...
                    if (contact.IsEnabled() === !1) {
                        other.m_sweep.Copy(backup);
                        other.SynchronizeTransform();
                        continue
                    }
                    if (contact.IsTouching() === !1) {
                        other.m_sweep.Copy(backup);
                        other.SynchronizeTransform();
                        continue
                    }
        ...
        case box2d.b2ShapeType.e_circleShape:
            {
                ...
                var axis = box2d.b2Vec2.UNITX;this.m_debugDraw.DrawSolidCircle(center, radius, axis, color)
            }
            break;
        case box2d.b2ShapeType.e_edgeShape:
            {
                ...
                var v2 = edge.m_vertex2;this.m_debugDraw.DrawSegment(v1, v2, color)
            }
            break;
        ...
        case box2d.b2ShapeType.e_polygonShape:
            {
                ...
                var vertices = poly.m_vertices;this.m_debugDraw.DrawSolidPolygon(vertices, vertexCount, color)
            }
            break
    }
}
        ...
        case box2d.b2JointType.e_pulleyJoint:
            {
                ...
                var s2 = pulley.GetGroundAnchorB(box2d.b2World.prototype.DrawJoint.s_s2);this.m_debugDraw.DrawSegment(s1, p1, color);this.m_debugDraw.DrawSegment(s2, p2, color);this.m_debugDraw.DrawSegment(s1, s2, color)
            }
            break;
        case box2d.b2JointType.e_mouseJoint:
            this.m_debugDraw.DrawSegment(p1, p2, color);
...
box2d.b2TensorDampingController.prototype.Step = function (step) {
    ...
    for (var i = this.m_bodyList; i; i = i.nextBody) {
        ...
        if (!body.IsAwake())
            continue;
        var damping = body.GetWorldVector(box2d.b2MulMV(this.T, body.GetLocalVector(body.GetLinearVelocity(), box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t1), box2d.b2TensorDampingController.prototype.Step.s_damping);
...
box2d.b2DistanceJoint.prototype.SolvePositionConstraints = function (data) {
    ...
    var qA = this.m_qA.SetAngleRadians(aA),
        qB = this.m_qB.SetAngleRadians(aB);
    var rA = box2d.b2MulRV(this.m_qA, this.m_lalcA, this.m_rA);
    var rB = box2d.b2MulRV(this.m_qB, this.m_lalcB, this.m_rB);
    var u = this.m_u;
...
box2d.b2FrictionJoint.prototype.SolveVelocityConstraints = function (data) {
    ...
    if (!0) {
        var Cdot = box2d.b2SubVV(box2d.b2AddVCrossSV(vB, wB, this.m_rB, box2d.b2Vec2.s_t0), box2d.b2AddVCrossSV(vA, wA, this.m_rA, box2d.b2Vec2.s_t1), box2d.b2FrictionJoint.prototype.SolveVelocityConstraints.s_Cdot);
...
box2d.b2MouseJoint.prototype.SolveVelocityConstraints = function (data) {
    ...
    var impulse = box2d.b2MulMV(this.m_mass, box2d.b2AddVV(Cdot, box2d.b2AddVV(this.m_C, box2d.b2MulSV(this.m_gamma, this.m_impulse, box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0).SelfNeg(), box2d.b2MouseJoint.prototype.SolveVelocityConstraints.s_impulse);
...
box2d.b2CircleShape = function (radius) {
    goog.base(this, box2d.b2ShapeType.e_circleShape, radius || 0);
...
box2d.b2CircleShape.prototype.SetupDistanceProxy = function (proxy, index) {
    proxy.m_vertices = new Array(1, !0);
...
box2d.b2Rope.prototype.Initialize = function (def) {
    ...
    for (var i = 0; i < count3; ++i) {
        ...
        var d1 = box2d.b2SubVV(p2, p1, box2d.b2Vec2.s_t0);
        var d2 = box2d.b2SubVV(p3, p2, box2d.b2Vec2.s_t1);
        var a = box2d.b2CrossVV(d1, d2);
        var b = box2d.b2DotVV(d1, d2);
...
box2d.b2Rope.prototype.Step = function (h, iterations) {
    if (h === 0) {
        return
    }
...
box2d.b2Rope.prototype.SolveC2 = function () {
    ...
    for (var i = 0; i < count2; ++i) {
        var p1 = this.m_ps[i];
        var p2 = this.m_ps[i + 1];
        var d = box2d.b2SubVV(p2, p1, box2d.b2Rope.s_d);
        var L = d.Normalize();
...
box2d.b2Rope.prototype.SolveC3 = function () {
    ...
    for (var i = 0; i < count3; ++i) {
        ...
        var d1 = box2d.b2SubVV(p2, p1, box2d.b2Rope.s_d1);
        var d2 = box2d.b2SubVV(p3, p2, box2d.b2Rope.s_d2);
        ...
        var Jd1 = box2d.b2MulSV((-1 / L1sqr), d1.SelfSkew(), box2d.b2Rope.s_Jd1);
        var Jd2 = box2d.b2MulSV((1 / L2sqr), d2.SelfSkew(), box2d.b2Rope.s_Jd2);
        var J1 = box2d.b2NegV(Jd1, box2d.b2Rope.s_J1);
        var J2 = box2d.b2SubVV(Jd1, Jd2, box2d.b2Rope.s_J2);
        var J3 = Jd2;
        var mass = m1 * box2d.b2DotVV(J1, J1) + m2 * box2d.b2DotVV(J2, J2) + m3 * box2d.b2DotVV(J3, J3);
        if (mass === 0) {
            continue
        }
        mass = 1 / mass;
...
box2d.b2WheelJoint.prototype.InitVelocityConstraints = function (data) {
    ...
    box2d.b2SubVV(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB);
    var rB = box2d.b2MulRV(qB, this.m_lalcB, this.m_rB);
    var d = box2d.b2SubVV(box2d.b2AddVV(cB, rB, box2d.b2Vec2.s_t0), box2d.b2AddVV(cA, rA, box2d.b2Vec2.s_t1), box2d.b2WheelJoint.prototype.InitVelocityConstraints.s_d); {
    ...
    if (data.step.warmStarting) {
        ...
        this.m_motorImpulse *= data.step.dtRatio;
        var P = box2d.b2AddVV(box2d.b2MulSV(this.m_impulse, this.m_ay, box2d.b2Vec2.s_t0), box2d.b2MulSV(this.m_springImpulse, this.m_ax, box2d.b2Vec2.s_t1), box2d.b2WheelJoint.prototype.InitVelocityConstraints.s_P);
...
box2d.b2WheelJoint.prototype.SolvePositionConstraints = function (data) {
    ...
    box2d.b2SubVV(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB);
    var rB = box2d.b2MulRV(qB, this.m_lalcB, this.m_rB);
    var d = box2d.b2AddVV(box2d.b2SubVV(cB, cA, box2d.b2Vec2.s_t0), box2d.b2SubVV(rB, rA, box2d.b2Vec2.s_t1), box2d.b2WheelJoint.prototype.SolvePositionConstraints.s_d);
...
Phaser.Physics.Box2D.prototype = {
    ...
    setBoundsToWorld: function (left, right, top, bottom, collisionCategory, collisionMask) {
        ...
        if (typeof collisionCategory === 'undefined') {
            collisionCategory = 1
        }
    ...
    getFixturesAtPoint: function (x, y, onlyOne, onlyDynamic) {
        ...
        if (typeof onlyDynamic === 'undefined') {
            onlyDynamic = !1
        }
    ...
    mouseDragStart: function (point) {
        this.mouseDragEnd();
        var fixturesAtPoint = this.getFixturesAtPoint(point.x, point.y, !0, !0);
    ...
    revoluteJoint: function (bodyA, bodyB, ax, ay, bx, by, motorSpeed, motorTorque, motorEnabled, lowerLimit, upperLimit, limitEnabled) {
        ...
        if (typeof motorSpeed === 'undefined') {
            motorSpeed = 0
        }
        if (typeof motorTorque === 'undefined') {
            motorTorque = 0
        }
        if (typeof motorEnabled === 'undefined') {
            motorEnabled = !1
        }
        ...
        if (typeof limitEnabled === 'undefined') {
            limitEnabled = !1
        }
        ax = this.pxm(-ax);
        ay = this.pxm(-ay);
    ...
    prismaticJoint: function (bodyA, bodyB, axisX, axisY, ax, ay, bx, by, motorSpeed, motorForce, motorEnabled, lowerLimit, upperLimit, limitEnabled, offsetAngle) {
        ...
        if (typeof offsetAngle === 'undefined') {
            offsetAngle = 0
        }
        axisX *= -1;
        axisY *= -1;
    ...
    pulleyJoint: function (bodyA, bodyB, ax, ay, bx, by, gax, gay, gbx, gby, ratio, lengthA, lengthB) {
        ...
        if (typeof gay === 'undefined') {
            gay = 0
        }
        if (typeof gbx === 'undefined') {
            gbx = 0
        }
        ...
        if (typeof lengthA === 'undefined') {
            lengthA = 100
        }
        if (typeof lengthB === 'undefined') {
            lengthB = 100
        }
        ax = this.pxm(-ax);
        ay = this.pxm(-ay);
            ...
            for (var x = 0, w = map.layers[layer].width; x < w; x++) {
                ...
                if (tile && tile.index > -1 && tile.collides) {
                    if (optimize) {
                        ...
                        var body = this.createBody(tile.x * tile.width, tile.y * tile.height, 0, !1);
    ...
    raycast: function (x1, y1, x2, y2, closestHitOnly, filterFunction) {
        if (typeof closestHitOnly === 'undefined') {
            closestHitOnly = !0
        }
        ...
        for (var i = 0; i < callback.hits.length; i++) {
            ...
            hit.point = {
                x: this.mpx(-hit.point.x),
                y: this.mpx(-hit.point.y)
            };
            hit.normal = {
                x: -hit.normal.x,
                y: -hit.normal.y
...
Phaser.Physics.Box2D.RayCastCallback.prototype.ReportFixture = function (fixture, point, normal, fraction) {
    if (this.filterFunction !== null) {
        var pxPoint = {
            x: this.world.mpx(-point.x),
            y: this.world.mpx(-point.y)
        };
        var pxNormal = {
            x: -normal.x,
            y: -normal.y
...
Phaser.Physics.Box2D.Body.prototype = {
    ...
    setCategoryContactCallback: function (category, callback, callbackContext) {
        if (callback === null) {
            ...
            delete(this._categoryContactCallbackContext[category])
        } else {
    ...
    setCategoryPresolveCallback: function (category, callback, callbackContext) {
        if (callback === null) {
            ...
            delete(this._categoryPresolveCallbackContext[category])
        } else {
    ...
    applyForce: function (x, y) {
        this.data.ApplyForce(new box2d.b2Vec2(-x, -y), this.data.GetWorldCenter(), !0)
    },
    ...
    thrust: function (power) {
        ...
        this.data.ApplyForce(force, this.data.GetWorldCenter(), !0)
    },
    ...
    addLoop: function (vertices, firstIndex, count) {
        return this.addChain(vertices, firstIndex, count, !0)
    },
    ...
    setLoop: function (vertices, firstIndex, count) {
        return this.setChain(vertices, firstIndex, count, !0)
    },
...
Phaser.Physics.Box2D.DefaultDebugDraw.prototype.DrawCircle = function (center, radius, color) {
    ...
    var ctx = this.context;
    ctx.beginPath();
    ctx.arc(center.x, center.y, radius, 0, Math.PI * 2, !0);
    ctx.strokeStyle = color.MakeStyleString(1);
    ctx.stroke()
};
...
Phaser.Physics.Box2D.Polygon.prototype.indicesAreAdjacent = function (a, b) {
    ...
    if (diff == this.vertices.length - 1) {
        return !0
    }
    return !1
};
